...
This plan ensures we keep all the original data (real data) and color palette while completely overhauling the presentation to be native and performant on mobile.
