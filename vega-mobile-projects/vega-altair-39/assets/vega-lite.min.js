!(function (e, t) {
  ...
  function J(e, n) {
    return t.isObject(e) && t.hasOwnProperty(e, n) && void 0 !== e[n];
  }
  const K = "row",
    Z = "column",
    ee = "facet",
  ...
  function sn(e) {
    return t.isString(e) && t.hasOwnProperty(nn, e);
  }
  ...
  function _i(e, n) {
    ...
    if (
      (n &&
        ...
        (Si(
          (function (e) {
            return `Dropping day from datetime ${Q(e)} as day cannot be combined with other units.`;
          })(e),
        ),
        delete (e = l(e)).day),
  ...
  function Hi(e) {
    ...
    if (
      (function (e) {
        return t.hasOwnProperty(Vi, e);
      })(e)
    )
      return { part: e, step: n };
    switch (e) {
      case "day":
      case "dayofyear":
  ...
  function Sa(e, n, i) {
    ...
    if (t.isString(e) || t.isNumber(e) || t.isBoolean(e)) {
      return (
        Si(
          (function (e, t, n) {
            return `Channel ${e} is a ${t}. Converted to {value: ${Q(n)}}.`;
          })(
            n,
  ...
  function ms(e, t) {
    ...
    const i = (function (e) {
        return oa(e.x2) || oa(e.y2);
      })(n),
      r = (function (e) {
        return oa(e.xError) || oa(e.xError2) || oa(e.yError) || oa(e.yError2);
      })(n),
      o = n.x,
      a = n.y;
    if (i) {
  ...
  const Zl = new (class extends rl {
      ...
      mapRepeat(e, n) {
        return (function (e) {
          return !t.isArray(e.repeat) && J(e.repeat, "layer");
        })(e)
  ...
  function cc(e, t, n, i) {
    return (
      e.explicit &&
        ...
        Si(
          (function (e, t, n, i) {
            return `Conflicting ${t.toString()} property "${e.toString()}" (${Q(n)} and ${Q(i)}). Using ${Q(n)}.`;
          })(n, i, e.value, t.value),
        ),
      e
    );
  ...
  function uc(e, t, n, i) {
    let r = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : cc;
    ...
    if (o || s) {
      ...
      (s = a.project.items[0].field),
        a.project.items.length > 1 &&
          Si(
            (function (e) {
              return `A "field" or "encoding" must be specified when using a selection as a scale domain. Using "field": ${t.stringValue(e)}.`;
            })(s),
          );
  ...
  const xf = {
    ...
    grid: (e) => {
      ...
      return (
        n.grid ??
        (function (e, t) {
          return !kr(e) && Zo(t) && !mn(t?.bin) && !pn(t?.bin);
        })(i, t)
      );
    },
    gridScale: (e) => {
  ...
  function gm(e, t, n, i) {
    return (
      e.explicit &&
        ...
        Si(
          (function (e, t, n, i) {
            return `Conflicting ${t.toString()} property "${e.toString()}" (${Q(n)} and ${Q(i)}). Using the union of the two domains.`;
          })(n, i, e.value, t.value),
        ),
  ...
  function hm(e) {
    ...
    const r = b(
      i.map((e) =>
        z(e) || !("op" in e) || (t.isString(e.op) && t.hasOwnProperty(rn, e.op))
          ? e
          : (Si(
              (function (e) {
                return `Dropping sort property ${Q(e)} as unioned domains only support boolean or op "count", "min", and "max".`;
              })(e),
            ),
            !0),
      ),
  ...
  function ym(e) {
    ...
    if (
      (function (e) {
        return !t.isArray(e) && J(e, "fields") && !J(e, "data");
      })(e)
    ) {
      let n;
      ...
      return [
        {
          ...
          sort: {
            field: Be.map((e) => this.facetSortFields(e)).flat(),
            order: Be.map((e) => this.facetSortOrder(e)).flat(),
          },
          ...(t.length > 0 ? { data: t } : {}),
          ...(n ? { encode: { update: n } } : {}),
