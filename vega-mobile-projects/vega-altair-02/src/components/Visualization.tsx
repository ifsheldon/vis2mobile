...
export function Visualization() {
  ...
  // Actually we know the domain is 0 to 100, and threshold is 50.
  // In SVG coordinates, y1=0 is top (100), y2=1 is bottom (0).
  // So 50 is at 50% of the height.
  // The offset should be 0.5.
  const off = 0.5;
  ...
  return (
    <div className="flex h-full w-full flex-col bg-gradient-to-br from-slate-900 to-slate-800 text-slate-100 p-6 relative overflow-hidden font-sans">
      ...
      <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
        <div className="absolute top-[-50px] right-[-50px] w-64 h-64 bg-violet-500 rounded-full blur-3xl"></div>
