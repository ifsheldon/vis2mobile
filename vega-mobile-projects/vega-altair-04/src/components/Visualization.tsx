    ...
    <div className='w-full h-full bg-[#0f172a] text-slate-200 p-5 flex flex-col font-sans overflow-hidden'>
      ...
      <div className='flex flex-wrap gap-2 mb-6'>
        {sources.map((source) => (
          ...
          >
            <source.icon
              className={`w-3.5 h-3.5 ${source.name === "Fossil Fuels" ? "text-slate-400" : source.name === "Nuclear Energy" ? "text-amber-400" : "text-emerald-400"}`}
            />
          ...
          <div className='flex justify-between w-full gap-2'>
            {sources.map((source) => {
              ...
              return (
                ...
                >
                  <source.icon
                    className={`w-5 h-5 mb-2 ${source.name === "Fossil Fuels" ? "text-slate-400" : source.name === "Nuclear Energy" ? "text-amber-400" : "text-emerald-400"}`}
                  />
