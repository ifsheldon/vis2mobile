    ...
    return (
        <div className="flex flex-col gap-4 p-4 bg-white dark:bg-zinc-950 w-full max-w-md mx-auto h-full overflow-y-auto">
            ...
            <div className="relative w-full">
                ...
                <div className="w-full aspect-[1.13]"> {/* 1060/936 ~= 1.13 */}
                    <svg
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                    <div
                                        ...
                                        style={{ backgroundColor: CANDIDATE_COLORS[selectedRegion.winner] }}
                                    />
            ...
            <div className="space-y-3 mt-2">
                ...
                {stories.map((story) => (
                    <button
                        ...
                        className={`w-full text-left p-3 rounded-lg border text-sm transition-colors ${selectedRegion?.id === story.id
